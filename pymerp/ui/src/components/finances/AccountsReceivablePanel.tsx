...
import { getAccountsReceivable, type AccountReceivable, type PaginatedResponse } from "../../services/client";
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-neutral-950">
            <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-neutral-400 uppercase">Cliente</th>
