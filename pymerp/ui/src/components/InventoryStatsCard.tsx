  ...
  const cards = [
    {
      ...
      value:
        kpis?.stockCoverageDays !== null && kpis?.stockCoverageDays !== undefined
      ...
      {cards.map((card, index) => (
        ...
        >
          <div className="flex items-start justify-between mb-3">
            ...
            <div
              className={`w-10 h-10 rounded-lg ${card.bgColor} border ${card.borderColor} flex items-center justify-center`}
            >
