...
export default function SalesForecastChart() {
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6">
      <h3 className="text-lg font-semibold text-white mb-6">Pronóstico de Demanda - Top 5 Productos</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        {top5.map((item, index) => {
          ...
          return (
            <div key={item.productId} className="bg-neutral-800 border border-neutral-700 rounded-lg p-3">
              ...
              <div className="text-xs text-neutral-400 mb-1">
                Pronóstico: <span className="text-white font-semibold">{item.forecastedDemand.toFixed(0)} u/mes</span>
              </div>
              <div className="text-xs text-neutral-400">
                Histórico: {item.historicalAverage.toFixed(0)} u/mes
              </div>
              <div className={`text-xs font-semibold mt-1 ${
                variation > 0 ? "text-red-400" : variation < 0 ? "text-green-400" : "text-neutral-400"
              }`}>
              ...
              <div className="mt-2 text-xs">
                ...
                <span className={`font-semibold ${
                  item.confidence >= 70 ? "text-green-400" : 
