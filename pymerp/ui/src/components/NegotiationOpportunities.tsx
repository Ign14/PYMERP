...
import {
  ...
  NegotiationOpportunity as OpportunityType,
    ...
    return (
      <div className="card-content">
        ...
        <p className="text-red-400 mt-4">
          {opportunitiesQuery.error?.message ?? 'Error al cargar oportunidades'}
        </p>
      </div>
    )
  }
      ...
      {opportunities.length === 0 ? (
        <div className="text-center py-12 bg-neutral-900/50 rounded border border-neutral-800">
          ...
          <p className="text-xs text-neutral-500 mt-2">
            Tus precios están alineados con el mercado o no hay suficientes proveedores para
            comparar
          </p>
        </div>
      ) : (
                  ...
                  >
                    <td className="py-3 px-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-0.5 text-xs font-medium rounded border ${getPriorityColor(opp.priority)}`}
                        >
                          {getPriorityLabel(opp.priority)}
                        </span>
                      </div>
                    </td>
                    <td className="py-3 px-2 text-neutral-200 font-medium">{opp.supplierName}</td>
                    <td className="py-3 px-2 text-neutral-300">{opp.productName}</td>
                    ...
                    <td className="py-3 px-2 text-right">
                      <div className="flex flex-col items-end">
                        ...
                        <span className="text-xs text-neutral-500">si iguala mercado</span>
                      </div>
                    </td>
          ...
          <div className="mt-4 pt-3 border-t border-neutral-800">
            ...
            <details className="text-xs text-neutral-500">
              ...
              <div className="mt-2 space-y-1 pl-4">
                <p>
                  • Se comparan los precios de cada proveedor contra el promedio del mercado (otros
                  proveedores del mismo producto)
                </p>
                <p>
                  • Se detectan casos donde el precio actual está <strong>&gt;10%</strong> por
                  encima del promedio
                </p>
                <p>
                  • <strong>Savings potenciales</strong> = Diferencia de precio × Cantidad comprada
                  en últimos 12 meses
                </p>
                <p>
                  • <strong>Prioridad Alta</strong>: Savings &gt; $100,000 | <strong>Media</strong>:
                  $50,000-$100,000 | <strong>Baja</strong>: &lt; $50,000
                </p>
                <p className="mt-2">
                  💡 <strong>Acción recomendada</strong>: Contactar proveedores de prioridad alta y
                  negociar reducción de precios
                </p>
              </div>
            </details>
          </div>
