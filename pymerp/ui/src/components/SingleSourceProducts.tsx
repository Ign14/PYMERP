    ...
    return (
      <div className="card-content">
        ...
        <p className="text-red-400 mt-4">
          {productsQuery.error?.message ?? 'Error al cargar productos'}
        </p>
      </div>
    )
  }
                  ...
                  >
                    <td className="py-3 px-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-0.5 text-xs font-medium rounded border ${getRiskColor(product.riskLevel)}`}
                        >
                    ...
                    <td className="py-3 px-2 text-neutral-300">{product.supplierName}</td>
          ...
          <div className="mt-4 pt-3 border-t border-neutral-800">
            ...
            <details className="text-xs text-neutral-500">
              ...
              <div className="mt-2 space-y-1 pl-4">
                <p>
                  • <strong>Continuidad del negocio</strong>: Si el único proveedor falla, no hay
                  alternativas inmediatas
                </p>
                <p>
                  • <strong>Poder de negociación</strong>: Proveedores únicos pueden subir precios
                  sin competencia
                </p>
                <p>
                  • <strong>Calidad y servicio</strong>: Múltiples proveedores permiten comparar y
                  exigir mejor calidad
                </p>
                <p>
                  • <strong>Resiliencia ante crisis</strong>: Diversificación reduce impacto de
                  problemas externos
                </p>
                <p className="mt-2">
                ...
                <p className="pl-2">
                  · <strong>Crítico</strong>: Gasto &gt; $500,000 | <strong>Alto</strong>:
                  $200,000-$500,000
                </p>
                <p className="pl-2">
                  · <strong>Medio</strong>: $50,000-$200,000 | <strong>Bajo</strong>: &lt; $50,000
                </p>
                <p className="mt-2">
                  💡 <strong>Acción recomendada</strong>: Buscar proveedores alternativos para
                  productos de riesgo crítico/alto
                </p>
              </div>
            </details>
          </div>
