  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-2xl shadow-lg p-5 mb-6">
      <header className="mb-4">
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">⏰ Timeline Diario de Ventas</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
          ...
          <p className="text-xs text-neutral-400 mt-1">{formatCurrency(peakHour.sales)} en {peakHour.count} ventas</p>
        </div>
        <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
          <h3 className="text-xs font-medium text-neutral-400 mb-1">Promedio por Hora</h3>
          <p className="text-2xl font-bold text-neutral-100">{formatCurrency(totalSales / hourlySales.length)}</p>
          <p className="text-xs text-neutral-400 mt-1">{(totalCount / hourlySales.length).toFixed(1)} ventas/hora</p>
        </div>
        <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
          <h3 className="text-xs font-medium text-neutral-400 mb-1">Ticket Promedio</h3>
          <p className="text-2xl font-bold text-neutral-100">{formatCurrency(totalSales / totalCount)}</p>
