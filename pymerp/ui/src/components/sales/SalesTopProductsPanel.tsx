...
function generateTopProducts(): ProductStat[] {
  return [
    ...
    {
      productId: 'P005',
      productName: 'Webcam HD Logitech C920',
      sku: 'LOG-CAM-920',
    ...
    {
      productId: 'P009',
      productName: 'Router WiFi 6 TP-Link',
      sku: 'TP-ROUTER-W6',
    ...
    {
      productId: 'P010',
      productName: 'Cable HDMI 2.1 Premium',
      sku: 'HDMI-21-PREM',
      totalRevenue: 950000,
      totalQuantity: 95,
      salesCount: 75,
              ...
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-neutral-400">
                    {product.totalQuantity.toLocaleString()} unidades
                  </p>
                </div>
              </div>
