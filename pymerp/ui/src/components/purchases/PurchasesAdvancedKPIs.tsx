    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/20 border border-purple-800 rounded-lg p-6">
          ...
          <div className="text-xs text-purple-300 mt-2">{kpis.totalOrders} órdenes recibidas</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-900/30 to-green-800/20 border border-green-800 rounded-lg p-6">
          ...
          <div className="text-xs text-green-300 mt-2">Promedio por unidad</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-5">
          ...
          <div className="text-xs text-neutral-500 mt-1">Órdenes recibidas</div>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-5">
          ...
          <div className="text-2xl font-bold text-white">
            {formatPercent(kpis.supplierConcentration)}
          </div>
          <div className="text-xs text-neutral-500 mt-1">Top proveedor</div>
        </div>
