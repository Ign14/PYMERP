...
export default function PurchaseForecastInsights() {
  ...
  const highSpenders = forecasts.filter(
    f => f.forecastedSpending > (totalForecasted / forecasts.length) * 2
  )
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6">
      <h3 className="text-lg font-semibold text-white mb-6">
        🔍 Insights y Alertas del Pronóstico
      </h3>
      ...
      <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-800 rounded-lg p-5 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <p
              className={`text-2xl font-bold ${globalVariation >= 0 ? 'text-red-400' : 'text-green-400'}`}
            >
              {globalVariation >= 0 ? '+' : ''}
          ...
          <div className="bg-red-900/20 border border-red-800 rounded-lg p-4">
            ...
            <div className="mt-3 pt-3 border-t border-red-800">
              <p className="text-xs text-red-200">
                💡 <strong>Acción:</strong> Revisar contratos y negociar mejores condiciones antes
                del aumento
              </p>
            </div>
          </div>
          ...
          <div className="bg-amber-900/20 border border-amber-800 rounded-lg p-4">
            ...
            <div className="mt-3 pt-3 border-t border-amber-800">
              <p className="text-xs text-amber-200">
                💡 <strong>Razón:</strong> Pocos datos históricos. Aumentar frecuencia de compras
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                <h4 className="text-green-400 font-semibold">
                  Proveedores con Tendencia Decreciente
                </h4>
            ...
            <div className="space-y-2">
              ...
              {decreasingTrends.length > 3 && (
                <p className="text-xs text-green-300 mt-2">
                  Y {decreasingTrends.length - 3} más...
                </p>
              )}
            </div>
            <div className="mt-3 pt-3 border-t border-green-800">
              <p className="text-xs text-green-200">
                💡 <strong>Oportunidad:</strong> Optimización exitosa o reducción de demanda.
                Evaluar causas
              </p>
            </div>
          </div>
          ...
          <div className="bg-purple-900/20 border border-purple-800 rounded-lg p-4">
              ...
              {highSpenders.slice(0, 3).map(f => (
                <div key={f.supplierId} className="flex justify-between items-center text-sm">
                  ...
                  <span className="text-purple-400 font-bold">
                    {formatCurrency(f.forecastedSpending)}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-3 pt-3 border-t border-purple-800">
              <p className="text-xs text-purple-200">
                💡 <strong>Recomendación:</strong> Negociar descuentos por volumen o contratos
                anuales
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="bg-neutral-900/50 rounded-lg p-3">
            ...
            <p className="text-neutral-300">
              Basándose en el pronóstico total de {formatCurrency(totalForecasted)}, asegúrese de
              tener liquidez suficiente para el próximo mes.
            </p>
          </div>
          <div className="bg-neutral-900/50 rounded-lg p-3">
            <p className="text-blue-300 font-medium mb-2">📊 Optimización de Inventario</p>
            <p className="text-neutral-300">
              Use las cantidades sugeridas como base para evitar sobre-stock o quiebres de
              inventario.
            </p>
          </div>
          <div className="bg-neutral-900/50 rounded-lg p-3">
            ...
            <p className="text-neutral-300">
              Revise las fechas estimadas de próxima compra para planificar pedidos con
              anticipación.
            </p>
          </div>
          <div className="bg-neutral-900/50 rounded-lg p-3">
            ...
            <p className="text-neutral-300">
              Los pronósticos se actualizan cada 5 minutos. Revise regularmente para decisiones
              informadas.
            </p>
          </div>
        </div>
