    ...
    <div className="card">
      <div className="card-header">
        ...
        <div className="card-actions">
          <button className="btn-link" onClick={() => companyQuery.refetch()} disabled={companyQuery.isFetching}>
        ...
        {!isLoading && !loadError && companySummary && !isEditing && (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            {companySummary.receiptFooterMessage ? (
              <p className="muted small">Mensaje en boletas: {companySummary.receiptFooterMessage}</p>
            ) : null}
            {companySummary.updatedAt ? (
              <p className="muted small">Ultima actualizacion: {new Date(companySummary.updatedAt).toLocaleString()}</p>
            ) : null}
            {notice ? (
          ...
          <form className="form-grid" onSubmit={handleSubmit} noValidate>
            <label>
              ...
              <input
                ...
                aria-describedby={fieldErrors.businessName ? "account-businessName-error" : undefined}
              />
