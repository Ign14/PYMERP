      ...
      <div className="card-body" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          <p className="muted small">
            Comparte este enlace con los usuarios que crees desde esta pagina para que inicien sesion con la
            contrasena entregada: <span className="mono">{LOGIN_URL}</span>
          </p>
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <h3>Sesion actual</h3>
          <p className="muted small">
            Cierra la sesion para probar nuevas credenciales o cambia de usuario sin abandonar la seccion de
            configuracion.
          </p>
