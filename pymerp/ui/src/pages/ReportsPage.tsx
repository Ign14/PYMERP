...
const mockReports = [
  {
    name: 'IVA mensual',
    description: 'Detalle compras y ventas con cr�dito fiscal',
    lastRun: '2025-09-01',
  },
  {
    name: 'Ventas por categor�a',
    description: 'Participaci�n de l�neas y margen',
    lastRun: '2025-09-18',
  },
  {
    name: 'Performance proveedores',
    description: 'Lead time, cumplimiento y descuentos',
    lastRun: '2025-09-10',
  },
]
